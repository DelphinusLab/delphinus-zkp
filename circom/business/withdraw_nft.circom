...
template WithdrawNFT() {
    ...
    // Check if owner, bidder, biddingAmount，args[5]，dataPath[62]--dataPath[64] are 0s and dataPath[61] != 0
    ...
    rangecheck.in <== dataPath[1][LeaveStartOffset];
    ...
    // Check caller permission and signer
